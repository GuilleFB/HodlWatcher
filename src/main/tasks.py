...
from alertas_bot import utils
from alertas_bot.models import InvestmentWatchdog, WatchdogNotification
...
def check_watchdogs():
    ...
    logger_task.info(f"Comprobando {watchdogs.count()} watchdogs activos")
    ...
    for notification in active_notifications:
        try:
            ...
            if response.status_code == 404:
                ...
                # La oferta sigue existiendo, actualizamos los detalles
            ...
            logger.error(f"Error al actualizar estado de oferta {notification.offer_id}: {str(e)}")
